        ...
        child: Center(
          child: Column(
            children: [
              ...
              Text(
                'OT 신청 완료!',
                style: TextStyle(fontSize: 26, color: gray900, fontWeight: FontWeight.w600, letterSpacing: -1),
              ),
              SizedBox(height: 34),
              Text('신청이 완료되었어요!\n적합한 트레이너가 배정되 나면 연락드릴게요.', style: TextStyle(fontSize: 14, color: gray500, fontWeight: FontWeight.w400), textAlign: TextAlign.center,),
              SizedBox(height: 16,),
              Image.asset(
                'image/good.png',
